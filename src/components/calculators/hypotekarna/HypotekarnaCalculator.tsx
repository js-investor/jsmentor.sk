        ...
        <div className="hypo-print-container max-w-full mx-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div
              ...
              className="bg-card p-6 md:p-7 rounded-xl border border-border relative overflow-hidden shadow-[0_10px_30px_-10px_rgba(41,106,82,0.12)] transition-opacity duration-300"
            >
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="bg-muted text-foreground text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-widest">
                  Dlh
                </span>
              </div>
              <div id="hypo-mortgage-fields" className="flex flex-col gap-5">
                <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <span className="absolute right-2.5 top-3.5 text-muted-foreground text-[11px]">rokov</span>
                    </div>
                  </div>
                  <div>
                    <label className="block text-[11px] font-bold uppercase tracking-wide text-muted-foreground mb-1.5">Úrok</label>
                    <div className="relative">
                      <input type="number" id="c-mortgage-rate" defaultValue={4.9} step={0.1} className="ml-input pr-9" />
                      <span className="absolute right-2.5 top-3.5 text-muted-foreground text-[11px]">%</span>
                    </div>
                  </div>
                </div>
                <div className="bg-cream p-4 rounded-lg border border-border">
                  <div className="flex justify-between items-end flex-wrap gap-4">
                    <div>
                      <span className="block text-[11px] uppercase text-muted-foreground font-bold tracking-wide mb-1">
                        Mesačná splátka
                      </span>
                    ...
                    <div className="text-right">
                      <span className="block text-xs text-muted-foreground">Celkovo zaplatíte</span>
                      <span className="text-sm font-bold text-foreground" id="c-total-paid">
                        0 €
                      </span>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="bg-cream text-primary text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-widest">
                  Majetok
                </span>
              </div>
              <div id="hypo-invest-fields" className="flex flex-col gap-5">
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-wide text-muted-foreground mb-1.5">
                    Jednorazový vklad
                  </label>
                ...
                <div className="bg-cream p-4 rounded-lg border border-border">
                  <div className="flex justify-between items-end flex-wrap gap-4">
                    ...
                    <div className="text-right">
                      <span className="block text-xs text-muted-foreground">Čistý zisk</span>
                      <span className="text-sm font-bold text-emerald-600" id="c-invest-profit">
                        0 €
                      </span>
                    </div>
                  </div>
          ...
          <div className="bg-card p-5 md:p-7 rounded-xl border border-border mb-7 shadow-[0_10px_30px_-10px_rgba(41,106,82,0.1)]">
            ...
            <div id="hypo-evt-accordion-content" className="mt-5 pt-5 border-t border-cream" style={{ display: "none" }}>
              ...
              <div className="bg-cream p-4 rounded-lg border border-dashed border-border">
                <h4 className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground m-0 mb-3.5">Pridať novú udalosť</h4>
                <div className="grid grid-cols-1 md:grid-cols-10 gap-3 items-end">
                  <div className="md:col-span-4">
                    <label className="text-[10px] uppercase text-muted-foreground font-bold block mb-1">Typ</label>
                    <select
                      id="evt-type"
                      className="w-full px-2.5 py-2 text-[13px] border border-border rounded-md bg-card h-10 text-foreground font-sans"
                    >
                  ...
                  <div className="md:col-span-2">
                    <label className="text-[10px] uppercase text-muted-foreground font-bold block mb-1">Rok</label>
                    <input
                      type="number"
                      id="evt-year"
                      min={1}
                  ...
                  <div className="md:col-span-2">
                    <label className="text-[10px] uppercase text-muted-foreground font-bold block mb-1">Hodnota</label>
                    <input
                      type="number"
                      id="evt-value"
                      min={0}
                  ...
                  <div className="md:col-span-2">
                    <button
                      ...
                      className="w-full bg-primary text-primary-foreground font-medium text-[13px] rounded-md h-10 border-none cursor-pointer font-sans hover:brightness-95 transition-[filter]"
                    >
                      + Pridať
                    </button>
                  </div>
          ...
          >
            <div className="flex justify-between items-center mb-5 flex-wrap gap-2">
              ...
              <div className="flex gap-3.5 text-xs font-medium" id="ml-chart-legend">
            ...
            <div
              ...
              style={{ display: "none" }}
              className="mt-5 text-center text-sm text-muted-foreground bg-cream p-3.5 rounded-lg border border-border"
            >
              <span className="hypo-heading text-[1.05rem] text-foreground block mb-1">Bod zlomu dosiahnutý</span>
              Investícia presiahne zostatok hypotéky v <span id="crossover-year" className="font-bold text-foreground" />.
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white text-foreground p-7 rounded-xl relative overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.06)] min-h-[150px] flex flex-col justify-between border border-border">
              <div className="relative z-[1]">
                <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-bold m-0 mb-2 opacity-95">
                  Celkové náklady úveru
                </p>
                <div className="hypo-heading text-[1.75rem] text-foreground" id="res-mortgage-total">
                  0 €
                </div>
                <p className="text-xs text-muted-foreground mt-1.5 mb-0">Istina + úroky</p>
              </div>
            </div>
            <div className="bg-[#FFF9F5] text-foreground p-7 rounded-xl relative overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.06)] min-h-[150px] flex flex-col justify-between border border-border">
              <div className="relative z-[1]">
                ...
                <div className="hypo-heading text-[1.75rem] text-foreground" id="res-invest-principal">
                  0 €
                </div>
                <p className="text-xs text-muted-foreground mt-1.5 mb-0">Vaše vklady</p>
              </div>
              <img
                src={brandPattern}
                alt=""
            ...
            <div className="bg-primary text-primary-foreground p-7 rounded-xl relative overflow-hidden shadow-[0_20px_40px_rgba(41,106,82,0.35)] min-h-[150px] flex flex-col justify-between">
              <div className="relative z-[1]">
                <p className="text-[10px] text-cream uppercase tracking-widest font-bold m-0 mb-2 opacity-95">
                  Čistý majetok na konci
                </p>
                <div className="hypo-heading text-[1.75rem] text-white" id="res-net-worth">
                  0 €
                </div>
                <p className="text-xs text-white/80 font-bold mt-1.5 mb-0">Investícia − zostatok hypotéky</p>
              </div>
              <img
                src={brandPattern}
                alt=""
        ...
        <div className="ml-modal-box">
          ...
          <div className="ml-slider-wrap">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-xs text-muted-foreground font-semibold" id="ml-slider-max">
                20
              </span>
            </div>
          </div>
